 ...
 <head>
     ...
     {{-- fonts --}}
     <link
         href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@400;500;600;700&family=Rajdhani:wght@300&family=Teko:wght@300&family=Zen+Loop&display=swap"
         rel="stylesheet" />
 ...
 <body translate="no">
     ...
     <article class="GoalsBoard">
         <header>
             <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.999 511.999"
                 style="enable-background: new 0 0 511.999 511.999" xml:space="preserve" class="GoalsBoard__icon">
                 <g>
                     <g>
   ...
   c1.727,3.497,5.062,5.921,8.922,6.482l18.162,2.64L278.064,146.405z" />
             ...
             <h1 class="GoalsBoardTitle">
                 <span class="GoalsBoardTitleTop">Startegy</span><span class="GoalsBoardTitleBottom">Long Vision</span>
             </h1>
         </header>
         <main class="body">
             @foreach ($goals as $item)
                 <div class="goal" data-id="{{ $item->id }}">
                     <div class="goalHeader">
                         <i class="lab la-deviantart spock"></i>
                         <p class="titleGoal">{{ $item->title }}</p>
                         <i class="las la-caret-down caret"></i>
                     </div>
                     <div class="Goaldescription none">
                         <div class="rowDesc">
                             <p>
                                 <span class="dateGoal" data-date="{{ $item->date }}">{{ $item->date }}</span>
                                 <span class="descGoal">
                                     {{ $item->description }}
                                 </span>
                             </p>
         ...
         <div class="addGoalForm none">
             <form>
                 <h1 id="formTitle">New Goal</h1>
                 <input type="text" placeholder="Goal Title..." id="TitleInputGoal" />
                 <input type="date" id="DateInputGoal" />
                 <textarea cols="30" rows="10" placeholder="Goal Description..." id="DescInputGoal"></textarea>
                 <div class="button" id="submitButton"><i class="las la-file-contract"></i></div>
             </form>
             <i class="las la-times-circle closeForm"></i>
         </div>
     </article>
     <script type="module" src="/js/goals/utilities.js"></script>
     <script type="module" src="/js/goals/goals.js"></script>
 </body>
